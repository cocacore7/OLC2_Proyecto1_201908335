        ...
        if self.operation == relationalOperation.MAYOR:
            ...
            if leftValue.getType() == typeExpression.STRING:
                if rightValue.getType() == typeExpression.STRING:
                    ...
                    print("No Se Permite Evaluar Operacion Mayor Igual Con "+ rightValue.getType() + " y " +leftValue.getType())
            elif leftValue.getType() == typeExpression.INTEGER:
                if rightValue.getType() == typeExpression.FLOAT:
                    return Symbol(
                    "",
                ...
                print("No Se Permite Evaluar Operacion Mayor Con Igual "+ rightValue.getType() + " y " +leftValue.getType())
            ...
            if leftValue.getType() == typeExpression.STRING:
                if rightValue.getType() == typeExpression.STRING:
                    ...
                    print("No Se Permite Evaluar Operacion Menor Igual Con "+ rightValue.getType() + " y " +leftValue.getType())
            elif leftValue.getType() == typeExpression.INTEGER:
                if rightValue.getType() == typeExpression.FLOAT:
                    return Symbol(
                    "",
